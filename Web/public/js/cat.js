document.addEventListener('DOMContentLoaded', () => {
    ...
    adoptButton.addEventListener('click', () => {
        ...
        document.querySelector('.confirm-adopt').addEventListener('click', () => {
            ...
            document.body.removeChild(catOverlay);

            // Tampilkan overlay kedua dengan pertanyaan kepuasan
            const satisfactionOverlay = document.createElement('div');
            satisfactionOverlay.classList.add('overlay');
            const satisfactionMessage = document.createElement('div');
            satisfactionMessage.classList.add('message');
            ...
            // Tambahkan event listener untuk menangani rating bintang
            const ratingContainer = document.querySelector('.rating-container');
            for (let i = 1; i <= 5; i++) {
                const star = document.createElement('span');
                star.classList.add('star');
                star.setAttribute('data-rating', i);
                star.innerHTML = '&#9733;'; // Bintang HTML entities
            ...
            function handleStarRating(event) {
                ...
                // Di sini Anda dapat menambahkan logika untuk mengirim rating ke server atau melakukan tindakan lainnya
                // Setelah itu, Anda dapat menghapus overlay kedua
            ...
            stars.forEach(star => {
                star.addEventListener('mouseenter', handleStarRating);
